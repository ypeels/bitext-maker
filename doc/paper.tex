...
These are the data sets and evaluation software used by the official benchmark cited in footnote \ref{foot:tst2010}.
...
% TODO TODO TODO: rerun these jobs with GIZA++ instead of mgiza! TINY difference in error bars, but should try to be as careful as possible
    % I suppose I MIGHT consider this if the paper is ACCEPTED, haha
\begin{table}[htb]
\begin{center}
%\begin{footnotesize}
...
For tst2014, revising the DEV set tst2010 instead leads to different local minima instead. 
A better explanation is that the effect of this amount and kind of noise is ill-defined.
