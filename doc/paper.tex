...
% hmm, this would up being disturbingly short...
...
%%%%% WAIT a second, doesn't this in principle just leave it up to Moses to pick up ``class phrases''?
...
% let's figure out how to do a ``figure''
