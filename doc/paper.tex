...
But making sentences using KPML is a lengthy process, involving a well-developed linguistic theory to explain the surface forms.
In contrast, our primary goal is to generate large parallel corpora of surface forms quickly. 
This also affords us a significant amount of flexibility as to the method of generation.
